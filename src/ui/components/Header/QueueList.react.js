        ...
        <div className={queueBodyClasses}>
          { shownQueue.map((track, index) => (
            <QueueListItem
              ...
              dragged={index === _self.state.draggedTrackIndex}
              draggedOver={index === _self.state.draggedOverTrackIndex}
              dragPosition={index === _self.state.draggedOverTrackIndex && _self.state.dragPosition}
              onDragStart={_self.dragStart}
              onDragOver={this.dragOver}
              onDragEnd={_self.dragEnd}
            />
            )) }
        </div>
      </div>
